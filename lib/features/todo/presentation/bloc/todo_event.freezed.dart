...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( TodoLoad value)?  load,required TResult orElse(),}){
final _that = this;
switch (_that) {
case TodoLoad() when load != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( TodoLoad value)  load,}){
final _that = this;
switch (_that) {
case TodoLoad():
return load(_that);}
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( TodoLoad value)?  load,}){
final _that = this;
switch (_that) {
case TodoLoad() when load != null:
return load(_that);case _:
...
class TodoLoad implements TodoEvent {
  const TodoLoad();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TodoLoad);
}
